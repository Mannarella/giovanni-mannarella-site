        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-foreground/70 mb-12">
              Sviluppo progetti su FonARCom, Fondimpresa, Fon.Ter. e altri fondi
              con analisi dei bisogni personalizzata.
            </p>
            ...
            <section className="bg-card rounded-lg p-8 md:p-12">
              ...
              <p className="text-foreground/70 mb-8">
                ...
                personalizzata su una delle opportunità disponibili.
              </p>
