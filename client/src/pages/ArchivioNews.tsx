    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold mb-3 text-foreground">Archivio News</h1>
          <p className="text-lg text-foreground/70 mb-10 max-w-2xl">Tutte le notizie e gli aggiornamenti su formazione finanziata, europrogettazione e sviluppo aziendale.</p>
              ...
              {news.map((item, idx) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-1 flex-wrap">
                    <p className="text-sm font-semibold text-primary">{item.entity}</p>
                    {item.date && (
                      <span className="text-xs text-foreground/40">{formatDate(item.date)}</span>
                    )}
                  </div>
