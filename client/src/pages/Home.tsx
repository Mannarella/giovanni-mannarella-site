...
export default function Home() {
  ...
  const openInSizedWindow =
    (url: string) => (event: React.MouseEvent<HTMLAnchorElement>) => {
      ...
      window.open(
        url,
        "_blank",
        `noopener,noreferrer,width=${width},height=${height},left=${Math.floor(left)},top=${Math.floor(top)}`
      );
    };
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        "Gestione percorsi formativi per qualifiche nazionali e regionali a valere su FSE+ e FESR.",
  ...
  const [linkedinPosts, setLinkedinPosts] = useState<
    { testo: string; data: string; url: string }[]
  >([]);
  useEffect(() => {
  ...
  const {
    ...
    isError: newsError,
  } = trpc.news.latest.useQuery(undefined, {
    retry: false,
  });
    ...
    <div className="min-h-screen bg-background text-foreground">
              ...
              {popupSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-foreground/60">
                    Ti contatteremo al più presto per approfondire il bando.
                  </p>
                </div>
              ) : (
        ...
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-foreground/80 mb-8 leading-relaxed">
              Supporto specializzato nella progettazione di iniziative
              formative, europrogettazione e sviluppo aziendale. Con oltre 15
              anni di esperienza, trasformo idee in progetti vincenti.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-5 text-lg text-foreground/80">
              <p>
                Sono <b>Giovanni Mannarella</b>, esperto in progettazione
                formativa, europrogettazione e consulenza aziendale. La mia
                formazione multidisciplinare combina competenze in economia,
                diritto, risorse umane e interculturalità.
              </p>
              <p>
                Ho conseguito tre lauree quinquennali (in Lingue, Economia e
                Filologia moderna) ed un master in Sviluppo e Gestione Etica
                delle Risorse Umane. Dal 2016 sono iscritto negli elenchi della
                Regione Emilia-Romagna come Esperto dei Processi Valutativi
                (EPV) e dal 2021 come Responsabile Formalizzazione Competenze
                (RFC).
              </p>
              <p>
                Dal 2022 sono in possesso dell'attestazione di qualità e
                qualificazione professionale in qualità di{" "}
                <b>Progettista della Formazione</b> ai sensi della l. 04/2013.
              </p>
              <p>
                Mi occupo di formazione da 15 anni e collaboro con associazioni,
                enti formativi ed aziende a carattere nazionale e territoriale.
              </p>
              <p>
                La mia missione è supportare organizzazioni e professionisti nel
                navigare il complesso panorama della formazione finanziata,
                dell'europrogettazione e dello sviluppo strategico, trasformando
      ...
      <section id="servizi" className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-foreground/70 mb-10 max-w-2xl">
            Offro una gamma completa di servizi specializzati per supportare la
            crescita e lo sviluppo della tua organizzazione.
          </p>
          <div className="grid md:grid-cols-2 gap-6">
            {services.map((service, idx) => {
              const Icon = service.icon;
              const serviceLinks = [
                "/servizi/fondi-interprofessionali",
                "/servizi/europrogettazione",
                "/servizi/qualifiche-regolamentate",
                ...
                <a href={serviceLinks[idx]} key={idx}>
                  <Card className="p-5 hover:shadow-warm transition-all duration-300 hover:-translate-y-1 bg-card border-border cursor-pointer h-full">
                    <div className="flex items-center gap-3 mb-3">
                      <div
                        className={`${service.color} w-10 h-10 shrink-0 rounded-lg flex items-center justify-center`}
                      >
      ...
      <section id="opportunita" className="py-16 md:py-24 bg-card">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-foreground/70 mb-10 max-w-2xl">
            Scopri gli ultimi bandi aperti e in apertura nei prossimi 3 mesi.
          </p>
                  ...
                  bandi.map((bando: any, idx: number) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <span
                          className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${getStatoBadgeColor(bando.stato)}`}
                        >
                          {bando.stato}
                        </span>
                      </td>
      ...
      <section id="news" className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-foreground/70 mb-10 max-w-2xl">
            Rimani aggiornato sugli ultimi sviluppi nel panorama della
            formazione e dello sviluppo aziendale.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-foreground/70 mb-10">
              Hai una domanda o desideri discutere di un progetto? Sono
              disponibile per una consulenza personalizzata.
            </p>
      ...
      <footer className="bg-foreground/5 border-t border-border py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-foreground/70 mb-4">
            Esperto in progettazione e consulenza strategica
          </p>
          <p className="text-foreground/60 text-sm">
            &copy; 2026 Giovanni Mannarella. Tutti i diritti riservati.
          </p>
